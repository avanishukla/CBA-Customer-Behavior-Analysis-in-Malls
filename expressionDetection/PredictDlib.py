...
glob = r'D:\Project\expressionDetection/expressionDetection'

#load dat file
predictor = dlib.shape_predictor(r"D:\Project\expressionDetection\expressionDetection\shape_predictor_68_face_landmarks.dat")  # Or set this to whatever you named the downloaded file
...
def get_expression(image):
    ...
    clf = joblib.load(r"D:\Project\expressionDetection\expressionDetection\DlibExpress.pkl")
...
img =  cv2.imread(r'C:\Users\Pinal\Desktop\project\expressionDetection\expressionDetection\Demo_Images\31_1.jpg')
