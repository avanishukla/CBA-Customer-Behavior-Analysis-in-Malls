...
<div class="panel-heading">
<div class="panel-title hidden-xs">
<span class="glyphicon glyphicon-tasks"></span><a href="loadAddSuperwiser.htm">Add superwiser</a></div>
</div>
...
<tbody>
<c:forEach var="list" items="${superwiserList}">
<tr>
<td>${list.superwiserId}</td>
<td>${list.superwiserFirstName}</td>
<td>${list.superwiserLastName}</td>

<td>${list.pv.postName}</td>
<td>${list.superwiserMobileNO}</td>
<%-- </c:forEach>
<c:forEach var="slist" items="${slist}"> --%>
<td>${list.slv.username}</td>
<td>${list.slv.password}</td>
<td><a href="editSuperwiser.htm?superwiserId=${list.superwiserId}&&superwiserLoginId=${list.slv.superwiserLoginId}">Edit</a>/<a href="deleteSuperwiser.htm?superwiserId=${list.superwiserId}&&slv=${list.slv.superwiserLoginId}">Delete</a></td>
</c:forEach>
