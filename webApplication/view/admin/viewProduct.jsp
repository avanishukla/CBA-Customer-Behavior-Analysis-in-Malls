...
<div class="panel-heading">
<div class="panel-title hidden-xs">
<span class="glyphicon glyphicon-tasks"></span><a href="loadAddProduct.htm">Add product</a></div>
</div>
...
<td><a href="editProduct.htm?productId=${list.productId}&&productName=${list.productName}&&productDescription=${list.productDescription}">Edit</a>/<a href="deleteProduct.htm?productId=${list.productId}&&productName=${list.productName}&&productDescription=${list.productDescription}">Delete</a></td>
<td><a href="loadAnalysis.htm?productId=${list.productId}"><input type="button" value="Start Analysis" ></a></td>
</tr>
</c:forEach>
</tbody>
</table>
