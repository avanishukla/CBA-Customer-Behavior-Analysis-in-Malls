...
<h2>Form for Adding Superwiser </h2>
</div>

<div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
<div class="panel heading-border">
<f:form action="insertSuperwiser.htm" modelAttribute="data" method="post" id="admin-form">
...
<div class="section">
<label class="field prepend-icon">
<f:input type="email" path="slv.username" value="" id="useremail" class="gui-input" placeholder="Email address" />
<label class="field-icon">
...
<div class="section">
<label  class="field prepend-icon">
<f:input type="text" path="superwiserMobileNO" value="" id="mobile_phone" class="gui-input phone-group" placeholder="Mobile number" />
<label class="field-icon">
...
<div class="section">
<label class="field prepend-icon">
<f:input type="password" path="slv.password" value="" autocomplete="off" id="password" class="gui-input" placeholder="Create a password" />
<label class="field-icon">
