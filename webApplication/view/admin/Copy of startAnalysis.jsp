...
htp.onreadystatechange = function()
	{
		...
		htp.open("get","http://127.0.0.1:5011/detect?videoName="+v.value,true);
		htp.send();
...
<select id="video" name="vd">
 ...
 <option value="${p.videoName}">${p.videoName}</option>
 </c:forEach>
</select> 
<c:set var="videoName" value="${vd}" scope="session"></c:set>
...
<span style="display:none; color:red;" id="sp1"><a href="getOutput.htm">Get Output</a></span>
</div>


<div class="panel-footer text-right">
<input type="submit" class="button btn-primary" onclick="fn1()"/>
