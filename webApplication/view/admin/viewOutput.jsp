...
<li class="crumb-trail">Manage History</li>
</ol>
</div>
...
<th>Product Name</th>
<th>Video Name</th>
<th>Analysis Graph</th>
<th>Analysed video</th>
<th>Action</th>
</tr>
</thead>
<tbody>
...
<tr>
<td>${list.vv.pv.productName}</td>
<td>${list.vv.videoName}</td>
<td><a href="${list.imagePath}">Image</a></td>

  <td><video type="video/webm" width="240" src="${list.videoPath}" controls></video></td> 
  
 <%-- <td><video type="video/webm" width="240" src="checkExpression/video/WIN_20180405_12_08_40_Pro_detected.webm" controls> </video></td>   
  <td><a href="${list.videoPath}">Video</a></td> --%>

<td><a href="deleteOutput.htm?outputId=${list.outputId}">Delete</a></td>
</tr>
</c:forEach>
