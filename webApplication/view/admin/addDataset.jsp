...
<h2> Form for Dataset</h2>
</div>

<div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
<div class="panel heading-border">
<f:form method="post" action="insertDataset.htm" id="admin-form" enctype="multipart/form-data">
<div class="panel-body bg-light">
<div class="section-divider mt20 mb40">
<span> Upload dataset here </span>
</div>
...
<input type="file" class="gui-file" name="dataset" id="file1" onChange="document.getElementById('uploader1').value = this.value;">
