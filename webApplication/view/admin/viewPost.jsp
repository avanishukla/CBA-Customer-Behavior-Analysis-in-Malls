...
<div class="panel-heading">
<div class="panel-title hidden-xs">
<span class="glyphicon glyphicon-tasks"></span><a href="loadAddPost.htm">Add Post</a></div>
</div>
...
<td>${list.postId}</td>
<td>${list.postName}</td>
<td>${list.postDescription}</td>
 <td><a href="editPost.htm?postId=${list.postId}&&postName=${list.postName}&&postDescription=${list.postDescription}">Edit</a>/<a href="deletePost.htm?postId=${list.postId}&&postName=${list.postName}&&postDescription=${list.postDescription}">Delete</a></td>
</tr>
</c:forEach>
</tbody>
</table>
