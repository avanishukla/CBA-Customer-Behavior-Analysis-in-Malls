...
<h2>Form for insertion of post </h2>
</div>

<div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
<div class="panel heading-border">
<f:form action="insertPost.htm" modelAttribute="data" method="get" id="admin-form">
...
<div class="section">
<f:label path="postName" class="field prepend-icon">
<f:input path="postName" value="" type="text" id="postname" class="gui-input" placeholder="Enter post..." />
<f:label path="postName" class="field-icon">
...
<f:label path="postDescription" class="field prepend-icon">
<f:textarea class="gui-textarea" id="post_desc" value="" path="postDescription" placeholder="Enter post" />
<f:label path="postDescription" class="field-icon">
