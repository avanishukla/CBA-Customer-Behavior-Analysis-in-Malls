...
<f:form action="updatePost.htm" modelAttribute="data" method="post" id="admin-form">
...
<div class="section">
<label path="postName" class="field prepend-icon">
<f:input path="postName"  type="text" id="postname" class="gui-input" placeholder="Enter post..." />
<label path="postName" class="field-icon">
...
<label path="postDescription" class="field prepend-icon">
<f:textarea class="gui-textarea" id="post_desc" path="postDescription" placeholder="Enter post" />
<label path="postDescription" class="field-icon">
