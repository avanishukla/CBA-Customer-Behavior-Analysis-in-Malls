...
<div class="panel-heading">
<div class="panel-title hidden-xs">
<span class="glyphicon glyphicon-tasks"></span><a href="loadAddVideo1.htm">Add video</a></div>
</div>
...
<td>${list.pv.productName}</td>
<td><a href="deleteVideo1.htm?videoId=${list.videoId}">Delete</a></td>
