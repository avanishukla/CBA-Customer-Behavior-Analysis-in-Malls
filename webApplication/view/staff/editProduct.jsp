...
<f:form action="updateProduct1.htm" modelAttribute="data" method="post" id="admin-form">
...
<f:input type="text" path="productName" id="productname"  class="gui-input" placeholder="Product name..." />
...
<label path="productDescription" class="field prepend-icon">
<f:textarea class="gui-textarea" id="product_desc" path="productDescription" placeholder="Enter product" />
<label path="productDescription" class="field-icon">
