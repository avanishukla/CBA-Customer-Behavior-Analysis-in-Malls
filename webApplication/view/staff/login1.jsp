		...
		<div class="admin-form theme-info" id="login1">
			<div class="row mb15 table-layout">
				<div class="col-xs-6 va-m pln">
					<a href="loadIndex.htm" title="Return to Dashboard"><center> <img
						src="adminResource/image/IMG-20180411-WA0003.jpg" title="AdminDesigns Logo"
						class="img-responsive w250"></center>
					</a>
				</div>
				<div class="col-xs-6 text-right va-b pr5">
					<div class="login-links">
						<a href="pages_login.html" class="active" title="Sign In">Sign
							In</a> <span class="text-white"> | </span> <!-- <a
