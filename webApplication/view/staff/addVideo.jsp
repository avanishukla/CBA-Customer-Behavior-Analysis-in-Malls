...
<li class="crumb-trail">Manage Video</li>
</ol>
</div>
...
<h2> Form for Video</h2>
</div>

<div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
<div class="panel heading-border">
<f:form method="post" action="insertVideo1.htm" modelAttribute="data" id="admin-form" enctype="multipart/form-data">
...
<input type="file" class="gui-file" name="video" id="file1" onChange="document.getElementById('uploader1').value = this.value;">
...
<f:select  path="pv.productId">
 <c:forEach var="p" items="${plist}" >
 <f:option value="${p.productId}">${p.productId}</f:option>
 </c:forEach>
</f:select> 
