...
<header class="navbar navbar-fixed-top">
	<div class="navbar-branding">
		<a class="navbar-brand" href="loadIndex.htm"> <b>CBA</b>
	...
	<ul class="nav navbar-nav navbar-right">
		<!-- <li class="dropdown"><a class="dropdown-toggle"
			...
			<ul
				...
				<li class="media"><a class="media-left" href="#"> <img
						src="adminResource/image/5.jpg" class="mw40" alt="avatar">
				</a>
				...
				<li class="media"><a class="media-left" href="#"> <img
						src="adminResource/image/2.jpg" class="mw40" alt="avatar">
				</a>
					<div class="media-body">
						<h5 class="media-heading mv5">
							Article <small> - 08/16/22</small>
						</h5>
						Last Updated 36 days ago by <a class="text-system" href="#">
							Max </a>
					</div></li>
				<li class="media"><a class="media-left" href="#"> <img
						src="adminResource/image/3.jpg" class="mw40" alt="avatar">
				</a>
					<div class="media-body">
						<h5 class="media-heading">
							Article <small class="text-muted">- 08/16/22</small>
				...
				<li class="media"><a class="media-left" href="#"> <img
						src="adminResource/image/4.jpg" class="mw40" alt="avatar">
				</a>
					<div class="media-body">
						<h5 class="media-heading mv5">
							Article <small class="text-muted">- 08/16/22</small>
		...
		<li class="dropdown"><a href="#"
			class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <!-- <img
				src="adminResource/image/1.jpg" alt="avatar" class="mw30 br64 mr15"> -->
...
<c:url value="/j_spring_security_logout" var="logoutUrl" />
				...
				<li class="dropdown-footer"><a href="${logoutUrl}" class=""> <span
