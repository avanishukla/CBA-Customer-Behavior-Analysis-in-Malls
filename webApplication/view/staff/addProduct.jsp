...
<h2> Form insertion of product</h2>
</div>

<div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
<div class="panel heading-border">
<f:form action="insertProduct1.htm" modelAttribute="data" method="get" id="admin-form">
<div class="panel-body bg-light">
<div class="section-divider mt20 mb40">
<span>Insert details here</span>
</div>

<div class="section" id="spy1">

<f:label path="productName" class="field prepend-icon">
<f:input type="text" path="productName" id="productname" value="" class="gui-input" placeholder="Product name..." />
<f:label path="productName" class="field-icon">
...
<f:label path="productDescription" class="field prepend-icon">
<f:textarea class="gui-textarea" id="product_desc" value="" path="productDescription" placeholder="Enter product" />
<f:label path="productDescription" class="field-icon">
    ...
    jQuery(document).ready(function() {
        ...
        $("#admin-form").validate({
            ...
            messages: {
                ...
                product_desc: {
                    required: 'Oops you forgot to write product description',
