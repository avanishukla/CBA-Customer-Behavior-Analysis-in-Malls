...
<div class="panel-heading">
<div class="panel-title hidden-xs">
<span class="glyphicon glyphicon-tasks"></span><a href="loadAddDataset.htm">Add dataset</a></div>
</div>
...
<tr>
<td>${list.datasetId}</td>
<td>${list.datasetName}</td>
<%-- <td><a href="editRule.htm?ruleId=${list.ruleId}&&ruleName=${list.ruleName}&&ruleDescription=${list.ruleDescription}">Edit</a>/<a href="deleteRule.htm?ruleId=${list.ruleId}&&ruleName=${list.ruleName}&&ruleDescription=${list.ruleDescription}">Delete</a></td>
 --%>
 <td>Edit/Delete</td>
 </tr>
</c:forEach>
